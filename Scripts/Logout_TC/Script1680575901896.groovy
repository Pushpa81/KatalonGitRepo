...
Windows.click(findWindowsObject('Object Repository/VIMP/UN Edit'))

Windows.clearText(findWindowsObject('Object Repository/VIMP/UN Edit'))

Windows.setText(findWindowsObject('Object Repository/VIMP/UN Edit'), 'Administrator')
...
Windows.click(findWindowsObject('VIMP/ConnectionType-ComboBox'))

Windows.click(findWindowsObject('VIMP/Primary-Server'))
...
Windows.click(findWindowsObject('Object Repository/VIMP/UserIcon Button'))

Windows.click(findWindowsObject('Object Repository/VIMP/Logout Button'))
